...
urlpatterns = [
    ...
    path('stock/bulk/', views.stock_bulk_agregar, name='stock_bulk_agregar'),
    ...
    path('productos/<int:pk>/galeria/', views.galeria_producto, name='galeria_producto'),
    path('productos/<int:pk>/galeria/reorder/', views.galeria_reorder, name='galeria_reorder'),
    path('productos/<int:pk>/galeria/<int:img_pk>/borrar/', views.galeria_borrar, name='galeria_borrar'),
