# WhatsApp templates · Ideas Boutique

WhatsApp Business permite plantillas pre-aprobadas pero la mayoría del tráfico
...
## 1. Confirmación de pedido online (cuando entra una orden)
...
```
{nombre}, salió tu pedido #{numero} 🚚
Llega entre {fecha_inicio} y {fecha_fin}.

Empresa: {empresa_envio}
Tracking: {codigo_tracking}

Cualquier cosa me avisas. ¡Gracias por confiar!
— Blanca
```
...
## 5. Volvió talla agotada (campaña de stock)
...
## 6. Recordatorio anual de uniformes (febrero)
...
## 8. Consulta de stock / talla

```
¡Hola! Te respondo al tiro.
...
## 9. Fuera de horario / mensaje automático (Business)
...
## 10. Pedido de reseña (post-compra +14 días)
